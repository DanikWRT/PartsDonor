...
_COND_LABEL = {
    PartCondition.working: "рабочая",
    PartCondition.for_parts: "на запчасти",
    PartCondition.untested: "не проверена",
    PartCondition.no_guarantee: "без гарантии",
}
_STATUS_LABEL = {
    ListingStatus.active: "на продаже",
    ListingStatus.negotiated: "в переговорах",
    ListingStatus.sold: "продано",
    ListingStatus.hidden: "скрыто",
}
